...
The .sql document containing all of my queries may be found [here](/Darspatialanalysis/darspatialanalysisqueries.sql).
The initial SQL exercise studying Dar es Salaam flood risk conducted by Joe Holler and the Middlebury College spring 2021 GEOG 323 class may be found [here](/Darspatialanalysis/osm_sql.sql).
